...
or intact study plots and ``Distance\_km'' from Makokou. The categorical
variable, ``Status'', will help with data visualization, and the
``Distance\_km'' variable will be used as a proxy from the defaunation
gradient in our analyses. A sample of our cleaned dataset is shown in
Table 3.
